  ...
  return (
    <>
      ...
      <div className="flex gap-5 border-b border-gray-200 dark:border-gray-800 mb-6">
        <div className="h-3 w-20 animate-pulse bg-gray-100 dark:bg-gray-800 mb-2.5" />
        <div className="h-3 w-8 animate-pulse bg-gray-50 dark:bg-gray-900 mb-2.5" />
        <div className="h-3 w-16 animate-pulse bg-gray-50 dark:bg-gray-900 mb-2.5" />
      </div>
